package com.rubenswieringa.book {
	...
	import com.rubenswieringa.drawing.DistortImage;
	import com.rubenswieringa.geom.Geom;
	import com.rubenswieringa.geom.PageFlip;
	...
	// PAGEFLIP PROCESSING:
		...
		protected function finishPageFlip ():void {
			...
			timer.removeEventListener(TimerEvent.TIMER, dragPageCorner);
			timer.stop();
	...
	// PAGEFLIP ASSISTANCE:
		...
		protected function getCurrentCorner():Point {
			...
			// determine corner:
			corner.x = (this.mouseX < this.width  * .5) ? 0 : 1;
			corner.y = (this.mouseY < this.height * .5) ? 0 : 1;
			// return value:
			return corner;
		}
